...
class EasmMgmtClientConfiguration(Configuration):  # pylint: disable=too-many-instance-attributes
    """Configuration for EasmMgmtClient.
    ...
    def __init__(self, subscription_id: str, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        super(EasmMgmtClientConfiguration, self).__init__(**kwargs)
        ...
        kwargs.setdefault("sdk_moniker", "mgmt-easm/{}".format(VERSION))
