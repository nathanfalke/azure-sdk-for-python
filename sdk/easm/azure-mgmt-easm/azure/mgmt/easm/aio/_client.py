...
class EasmMgmtClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype workspaces: azure.mgmt.easm.aio.operations.WorkspacesOperations
    :ivar labels: LabelsOperations operations
    :vartype labels: azure.mgmt.easm.aio.operations.LabelsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.easm.aio.operations.Operations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = EasmMgmtClientConfiguration(subscription_id=subscription_id, credential=credential, **kwargs)
