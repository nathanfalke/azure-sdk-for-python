...
from ...operations._operations import (
    build_assets_export_request,
    build_assets_get_request,
    build_assets_links_request,
...
class WorkspacesOperations:
    ...
    async def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.WorkspaceResponse:
