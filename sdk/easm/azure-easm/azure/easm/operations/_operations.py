...
def build_workspaces_get_request(
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}"
...
def build_assets_update_request(
    resource_group_name: str, workspace_name: str, subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_assets_get_request(
    asset_id: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_assets_links_request(
    asset_id: str,
    resource_group_name: str,
    workspace_name: str,
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/assets/{assetId}/links"  # pylint: disable=line-too-long
    path_format_arguments = {
        "assetId": _SERIALIZER.url("asset_id", asset_id, "str"),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
def build_assets_export_request(
    resource_group_name: str, workspace_name: str, subscription_id: str, *, filter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/assets:export"
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
            "resource_group_name", resource_group_name, "str", max_length=90, min_length=1
...
def build_data_connections_list_request(
    resource_group_name: str, workspace_name: str, subscription_id: str, *, skip: int = 0, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_data_connections_remove_request(
    data_connection_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_groups_list_request(
    resource_group_name: str,
    workspace_name: str,
    subscription_id: str,
    *,
...
def build_disco_groups_remove_request(
    disco_group_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_groups_get_request(
    disco_group_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_groups_put_request(
    disco_group_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_groups_list_runs_request(
...
def build_disco_groups_run_request(
    disco_group_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_groups_validate_request(
    disco_group_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_disco_templates_list_request(
    resource_group_name: str,
    workspace_name: str,
    subscription_id: str,
    *,
...
def build_disco_templates_get_request(
    disco_template_id: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_saved_filters_remove_request(
    saved_filter_name: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_tasks_get_request(
    task_id: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_tasks_download_request(
    task_id: str, resource_group_name: str, workspace_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/tasks/{taskId}:download"  # pylint: disable=line-too-long
    path_format_arguments = {
        "taskId": _SERIALIZER.url("task_id", task_id, "str"),
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str", min_length=1),
        "resourceGroupName": _SERIALIZER.url(
...
class WorkspacesOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.WorkspaceResponse:
        """Retrieve a workspace by workspaceName.
        ...
        :rtype: ~azure.easm.models.WorkspaceResponse
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.WorkspaceResponse]
        ...
        deserialized = self._deserialize("WorkspaceResponse", pipeline_response)
...
class AssetsOperations:
    ...
    def list(
        ...
        *,
        ...
        mark: Optional[str] = None,
        **kwargs: Any
    ) -> Iterable["_models.AssetResponse"]:
    ...
    @distributed_trace
    def get(self, asset_id: str, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.AssetResponse:
        """Retrieve an asset by assetId.

        Retrieve an asset by assetId.

        :param asset_id: The unique identifier for the asset in the format assetType$$assetName.
         Required.
        :type asset_id: str
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
    ...
    def links(
        ...
        **kwargs: Any
        ...
        """Retrieve linked asset details for the provided assetId.
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                request = build_assets_links_request(
                    asset_id=asset_id,
                    resource_group_name=resource_group_name,
                    workspace_name=workspace_name,
                    subscription_id=self._config.subscription_id,
    ...
    @distributed_trace
    def export(
        self, resource_group_name: str, workspace_name: str, *, filter: Optional[str] = None, **kwargs: Any
    ) -> _models.TaskResponse:
        """Perform a background datasheet export of assets matching the provided filter.  The response
        ...
        request = build_assets_export_request(
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
            filter=filter,
...
class DataConnectionsOperations:
    ...
    ) -> Iterable["_models.DataConnectionResponse"]:
...
class DiscoGroupsOperations:
    ...
    def list(
        ...
        *,
        ...
        skip: int = 0,
        **kwargs: Any
    ) -> Iterable["_models.DiscoGroupResponse"]:
    ...
    def list_runs(
        ...
        *,
        ...
        skip: int = 0,
        **kwargs: Any
    ) -> Iterable["_models.DiscoRunResponse"]:
...
class DiscoTemplatesOperations:
    ...
    def list(
        ...
        *,
        ...
        skip: int = 0,
        **kwargs: Any
    ) -> Iterable["_models.DiscoTemplateResponse"]:
...
class SavedFiltersOperations:
    ...
    def list(
        ...
        *,
        ...
        skip: int = 0,
        **kwargs: Any
    ) -> Iterable["_models.SavedFilterResponse"]:
    ...
    def put(
        ...
        **kwargs: Any
        ...
        """Create a saved filter with a given savedFilterName.
...
class TasksOperations:
    ...
    @distributed_trace
    def get(self, task_id: str, resource_group_name: str, workspace_name: str, **kwargs: Any) -> _models.TaskResponse:
    ...
    @distributed_trace
    def download(self, task_id: str, resource_group_name: str, workspace_name: str, **kwargs: Any) -> Iterator[bytes]:
        """Download task data for the provided taskId.
        ...
        request = build_tasks_download_request(
            task_id=task_id,
            resource_group_name=resource_group_name,
            workspace_name=workspace_name,
            subscription_id=self._config.subscription_id,
